...
4. **Cap your spending:** under *APIs & Services → Places API (New) → Quotas*, set a low daily request limit, and set a budget alert under *Billing → Budgets*.
...
npx wrangler deploy        # creates the PLACE_IDS KV namespace automatically
```
